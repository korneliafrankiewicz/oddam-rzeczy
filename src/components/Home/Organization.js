...
import {organizations} from "./organizationList";
...
const Organization = () => {
    ...
    const currentElements = organizations.slice(indexOfFirst, indexOfLast)
    ...
    return ( 
        <div>
            <ul className={classes.ulList} >{currentElements.map((organization, index) => {
               return <li key={index}>
               <div className={classes.liElements}>
                   <div className={classes.liElement}>
                    ...
                    <p className={classes.liElementDesc}>{organization.description}</p>
                   </div>
                 
                   <p className={classes.liElement}>{organization.items}</p>
               </div>
               </li>
            })}</ul>
